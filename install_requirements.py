...
def main():
    ...
    parser.add_argument("--requirements-file", default="requirements-docker.txt", help="Path to the requirements file")
    ...
    if not os.path.exists(args.requirements_file):
        ...
        print(f"Using {args.requirements_file} as the specified requirements file does not exist.")
