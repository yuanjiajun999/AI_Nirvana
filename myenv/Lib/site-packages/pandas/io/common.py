...
from typing import (IO, TYPE_CHECKING, Any, AnyStr, DefaultDict, Generic,
                    Literal, TypeVar, cast, overload)
...
from pandas.core.dtypes.common import (is_bool, is_file_like, is_integer,
                                       is_list_like)
...
if TYPE_CHECKING:
    ...
    from pandas._typing import (CompressionDict, CompressionOptions, FilePath,
