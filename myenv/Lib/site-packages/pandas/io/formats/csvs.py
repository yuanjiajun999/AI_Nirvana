...
from pandas.core.dtypes.generic import (ABCDatetimeIndex, ABCIndex,
...
if TYPE_CHECKING:
    from pandas._typing import (CompressionOptions, FilePath, FloatFormatType,
                                IndexLabel, StorageOptions, WriteBuffer, npt)
