...
from typing import (IO, TYPE_CHECKING, Any, Callable, Generic, Literal,
...
from pandas.io.common import (IOHandles, get_handle, stringify_path,
                              validate_header_arg)
from pandas.io.excel._util import (fill_mi_header, get_default_engine,
                                   get_writer, maybe_convert_usecols,
                                   pop_header_name)
...
if TYPE_CHECKING:
    ...
    from pandas._typing import (DtypeArg, DtypeBackend,
                                ExcelWriterIfSheetExists, FilePath, IntStrT,
                                ReadBuffer, Self, SequenceNotStr,
