...
from pandas.io.common import (file_exists, get_handle, is_file_like,
...
if TYPE_CHECKING:
    ...
    from pandas._typing import (BaseBuffer, DtypeBackend, FilePath,
                                HTMLFlavors, ReadBuffer, StorageOptions)
