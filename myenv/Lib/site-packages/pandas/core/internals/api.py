...
from pandas.core.internals.blocks import (check_ndim, ensure_block_shape,
                                          extract_pandas_array, get_block_type,
                                          maybe_coerce_values)
...
def make_block(
    ...
    from pandas.core.internals.blocks import DatetimeTZBlock, ExtensionBlock
