...
from toolz.itertoolz import (accumulate, concat, concatv, cons, count, diff,
                             drop, first, frequencies, get, getter, groupby,
                             interleave, interpose, isdistinct, isiterable,
                             iterate, join, last, mapcat, merge_sorted, nth,
                             partition, partition_all, peek, peekn, pluck,
                             random_sample, reduceby, remove, rest, second,
                             sliding_window, tail, take, take_nth, topk,
                             unique)
