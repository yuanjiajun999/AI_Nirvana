...
from ._multiarray_umath import (_UFUNC_API, _add_newdoc_ufunc, _expandtabs,
                                _expandtabs_length, _extobj_contextvar,
                                _get_extobj_dict, _lstrip_chars,
                                _lstrip_whitespace, _make_extobj, _ones_like,
                                _replace, _rstrip_chars, _rstrip_whitespace,
                                _strip_chars, _strip_whitespace)
