...
from typing import (Any, Protocol, Sequence, TypedDict, TypeVar, Union,
                    runtime_checkable)
...
from ._char_codes import (_BoolCodes, _ByteCodes, _BytesCodes, _CDoubleCodes,
                          ...
                          _LongCodes, _LongDoubleCodes, _LongLongCodes,
                          _ObjectCodes, _ShortCodes, _SingleCodes, _StrCodes,
                          _TD64Codes, _UByteCodes, _UInt8Codes, _UInt16Codes,
                          _UInt32Codes, _UInt64Codes, _UIntCCodes, _UIntCodes,
                          _UIntPCodes, _ULongCodes, _ULongLongCodes,
                          _UShortCodes, _VoidCodes)
