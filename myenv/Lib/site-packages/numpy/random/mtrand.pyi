...
import numpy as np
from numpy import (dtype, float32, float64, int8, int16, int32, int64, int_,
                   long, uint, uint8, uint16, uint32, uint64, ulong)
from numpy._typing import (ArrayLike, NDArray, _ArrayLikeFloat_co,
                           _ArrayLikeInt_co, _DoubleCodes, _DTypeLikeBool,
                           _DTypeLikeInt, _DTypeLikeUInt, _Float32Codes,
                           _Float64Codes, _Int8Codes, _Int16Codes, _Int32Codes,
                           _Int64Codes, _IntCodes, _LongCodes, _ShapeLike,
                           _SingleCodes, _SupportsDType, _UInt8Codes,
