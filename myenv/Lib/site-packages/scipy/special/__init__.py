...
from . import (_basic, _orthogonal, _ufuncs, add_newdocs, basic, orthogonal,
...
from ._support_alternative_backends import (chdtrc, entr, erf, erfc, expit,
                                            gammainc, gammaincc, gammaln, i0,
                                            i0e, i1, i1e, log_ndtr, logit,
                                            ndtr, ndtri, rel_entr, xlogy)
from ._ufuncs import *
