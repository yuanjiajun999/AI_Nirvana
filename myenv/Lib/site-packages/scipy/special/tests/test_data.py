...
from scipy.special import (bdtrik, beta, betainc, betaincinv, binom, btdtr,
                           btdtri, btdtria, btdtrib, cbrt, chndtr, digamma,
                           ellip_harm, ellip_harm_2, ellipe, ellipeinc, ellipk,
                           ellipkinc, ellipkm1, elliprc, elliprd, elliprf,
                           elliprg, elliprj, erf, erfc, erfcinv, erfinv,
                           ...
                           jv, jvp, kn, kv, kvp, log1p, lpmn, lpmv, lpn, lqmn,
                           lqn, mathieu_a, mathieu_b, mathieu_cem,
                           mathieu_modcem1, mathieu_modcem2, mathieu_modsem1,
                           mathieu_modsem2, mathieu_sem, nbdtrik, owens_t,
                           pdtrik, poch, sph_harm, spherical_jn, spherical_yn,
                           wright_bessel, yn, yv, yvp, zeta)
