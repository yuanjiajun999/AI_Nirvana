...
from numpy.testing import (assert_, assert_allclose, assert_almost_equal,
                           ...
                           assert_array_less, assert_equal, suppress_warnings)
...
from scipy.signal import (BadCoefficients, butter, choose_conv_method,
                          ...
                          correlation_lags, detrend, fftconvolve, filtfilt,
                          hilbert, hilbert2, invres, invresz, lfilter,
                          lfilter_zi, lfiltic, oaconvolve, residue, residuez,
                          sosfilt, sosfilt_zi, sosfiltfilt, tf2sos, tf2zpk,
                          unique_roots, vectorstrength, zpk2sos, zpk2tf)
