...
class TestLangChainAgent(unittest.TestCase):
    ...
    def test_summarization_task(self):
        result = self.agent.run_summarization_task("AI is the simulation of human intelligence in machines.")
...
class TestLangSmith(unittest.TestCase):
    ...
    def test_generate_code(self):
        result = self.langsmith.generate_code("Create a Python function to add two numbers.")
